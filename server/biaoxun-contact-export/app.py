...
def health():
    return {"ok": True, "service": "biaoxun-contact-export"}
...
if __name__ == "__main__":
    app.run(host="127.0.0.1", port=int(os.environ.get("CONTACT_EXPORT_PORT", "5100")), debug=False, threaded=True)
